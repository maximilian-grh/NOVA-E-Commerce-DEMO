...
function CustomerProfile({
  ...
  if (!customer) {
    ...
    customer;
    return (
      <div className="p-8 bg-white text-black flex flex-col lg:flex-row gap-10">
        ...
        <div className="bg-gray rounded-2xl p-8 max-w-md mt-4">
            ...
            {invoicesSortedByOrders.map((invoice, index) => (
              <div className="mt-2 pb-2" key={invoice.id}>
                ...
                <p className="flex">
                  ...
                  <div className="pl-2">
                    {invoice.status === "paid" ? (
                      <CheckCircleIcon className="h-6 w-8 text-green" />
                    ) : (
                      <div>
                        {/* invoice.status */}
                        <div className="text-red">Offen</div>
                      </div>
                    )}
                  </div>
                </p>
